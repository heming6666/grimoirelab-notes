...
class TaskRawDataCollection(Task):
    ...
    def execute(self):
        ...
        for repo in repos:
            ...
            # log:['用户名', 'grimoirelab-test', '--sleep-for-rate', '--api-token', 'xxx']
            logger.debug(backend_args)
            # log:[github] collection starts for https://github.com/heming6666/grimoirelab-test
            ...
            try:
                # 主要调用。去掉grimoire_elk.elk的feed_backend函数
